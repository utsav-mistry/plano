...
router.post('/', idempotency, authorize(ROLES.ADMIN, ROLES.INTERNAL_USER), quotationController.create);
...
router.post('/:id/convert', authorize(ROLES.ADMIN, ROLES.INTERNAL_USER), quotationController.convert);
