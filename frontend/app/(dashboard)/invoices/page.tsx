                       ...
                       <tr key={inv.id} className="group hover:bg-gray-25 transition-colors">
                          <td className="py-4 px-6">
                             <div className="flex flex-col">
                                ...
                                <Link 
                                  href={`/subscriptions/${typeof inv.subscriptionId === 'object' ? inv.subscriptionId.id : inv.subscriptionId}`} 
                                  className="text-[10px] text-plano-600 font-bold hover:underline"
                                >
                                   {typeof inv.subscriptionId === 'object' ? inv.subscriptionId.id : 'View Sub'}
                                </Link>
                             </div>
                          </td>
                          <td className="py-4 px-6">
