      ...
      <div className="flex flex-col gap-6 pb-12">
         ...
         <div className="flex items-center justify-between gap-4 bg-bg-surface p-4 rounded-card border border-border dark:border-sidebar-hover shadow-sm">
            ...
            <div className="flex items-center gap-2">
               <button onClick={exportPaymentsCsv} className="flex items-center gap-2 px-4 h-10 border border-border dark:border-sidebar-hover bg-bg-surface rounded-input text-[11px] font-bold uppercase tracking-widest text-text-secondary hover:bg-sidebar-hover transition-colors">
                  <Download size={14} />
                  Export
               </button>
            </div>
         ...
         <div className="bg-bg-surface rounded-card border border-border dark:border-sidebar-hover overflow-hidden shadow-sm min-h-[400px] flex flex-col">
            {isLoading ? (
               ...
               <div className="flex-1 flex flex-col items-center justify-center py-24 gap-4 text-center px-6">
                  ...
                  <Link href={toAdminPath(pathname, '/payments/new')} className="text-xs font-bold text-plano-600 uppercase tracking-widest hover:underline">
                     Record manual entry
                  </Link>
               </div>
            ) : (
