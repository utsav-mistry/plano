...
export default function NewProductPage() {
  ...
  const inputStyle = "w-full h-11 px-4 rounded-lg border border-border dark:border-sidebar-hover bg-white dark:bg-bg-page focus:border-plano-500 focus:bg-white dark:focus:bg-white/10 focus:outline-none transition-all text-sm font-sans text-text-primary";
    ...
    <div className="flex flex-col gap-8 pb-20 max-w-5xl">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 flex flex-col gap-8">
                ...
                {PRODUCT_TYPES.map((type) => (
                  ...
                  >
                    <div className={cn(
                      ...
                      form.type === type.value ? "bg-plano-600 text-white" : "bg-gray-100 dark:bg-sidebar-hover text-gray-400 group-hover:bg-plano-50"
                    )}>
                      {type.icon}
                    </div>
          ...
          <section className="bg-bg-surface p-8 rounded-card border border-border dark:border-sidebar-hover shadow-sm flex flex-col gap-8">
            <div className="flex items-center gap-3 pb-5 border-b border-sidebar-hover">
              <div className="w-10 h-10 rounded-xl bg-success-50 dark:bg-success-900/10 text-success-600 flex items-center justify-center">
                <IndianRupee size={20} />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col">
                ...
                <div className="relative">
                  ...
                  >
                    {CURRENCIES.map(c => (
                      <option key={c} value={c} className="bg-bg-surface text-text-primary">{c}</option>
                    ))}
                  </select>
