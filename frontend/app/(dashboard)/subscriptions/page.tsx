         ...
         <div className="flex items-center gap-3 overflow-x-auto pb-2 custom-scrollbar">
            {tabs.map((tab) => (
              <button
                ...
                style={activeTab !== tab.value ? undefined : undefined}
                className={cn(
         ...
         {isLoading ? (
           ...
           <>
            ...
            <div className="px-6 py-4 bg-gray-50/50 dark:bg-white/5 border-t border-border dark:border-sidebar-hover flex items-center justify-between">
               <span className="text-[10px] uppercase font-bold text-gray-500 tracking-widest">Showing {subscriptions.length} subscriptions</span>
